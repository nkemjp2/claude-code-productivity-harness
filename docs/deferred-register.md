...
|---|---|
| Blocking semantics for all 25 in-scope events | `blocks on exit 2` is documented, not executed. The empirical probe lands in the Phase 2 canary suite. Until then no gate may claim client-verified blocking. |
